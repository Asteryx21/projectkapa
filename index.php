...
<body>
  ...
  <div class="reverse hidden">
    ...
    <div class="desc">
      <h1>Τι προσφέρει η σελίδα μας</h1>
      <p>
      Η σελίδα μας προσφέρει στους χρήστες την ευκαιρία να μάθουν για περιβαλλοντικά ζητήματα, να συμμετάσχουν στις δράσεις μας και να συμβάλουν σε μια καθαρότερη πόλη. 
      <br><br>
      Χρησιμοποιώντας τον χάρτη, οι χρήστες μπορούν να μας βοηθήσουν να εντοπίσουμε περιοχές που χρειάζονται προσοχή. 
      <br><br>
      Παίζοντας το κουίζ, οι χρήστες μπορούν να αποκτήσουν γνώσεις για φιλικές προς το περιβάλλον πρακτικές. 
      <br><br>
      Επιπλέον, στο ημερολόγιο, οι χρήστες, μπορούν να ενημερώνονται για τις επερχόμενες εκδηλώσεις και να δηλώνουν ενδιαφέρων σε αυτές.
      </p>
    </div>
  </div>
  ...
  <div class="description hidden">
    <div class="desc">
      ...
      <p>Μπορείς πλέον και εσύ να συνεισφέρεις στο να έχουμε μια πιο καθαρή πόλη και να γίνεις ο νέος τοπικός σούπερ ήρωας. 
      <br>  
      Κάνε γρήγορα και εύκολα αναφορά μιας μολυσμένης περιοχής! <br><b>Γίνε μέλος της ομάδας μας σήμερα!</b>
      </p>
    </div>
